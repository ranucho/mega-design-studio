  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 flex items-center gap-1 px-6 py-3 bg-zinc-900/60 border-b border-zinc-800">
        {project && (
          <button
            ...
            className="mr-3 text-zinc-500 hover:text-white transition-colors text-sm"
            title="Start over"
          >
      ...
      <div className="flex-1 overflow-hidden">
        ...
        {currentStage === 'extract' && <BannerExtractor />}
              ...
              <div className="flex-1 overflow-hidden">
                {activeComposition ? (
                  ...
                  <div className="flex items-center justify-center h-full text-zinc-500 text-sm">
                    ...
                    Select a composition below to edit
                  </div>
                )}
              </div>
            ...
            <div className="shrink-0 border-t border-zinc-800 bg-zinc-900/60">
              ...
              <div className="flex items-center justify-end px-3 py-2 gap-3">
                ...
                <button
                  ...
                  className="px-5 py-1.5 text-xs font-medium bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg transition-colors shadow-lg shadow-cyan-600/20"
                >
                  Export
